...
desktop_path = '/opt/dcs/data/VLAN/'
old_vlan_file_path = os.path.join(desktop_path, 'old-vlan.txt')
new_vlan_file_path = os.path.join(desktop_path, 'new-vlan.txt')
different_file_path = os.path.join(desktop_path, 'vlan-different.txt')
