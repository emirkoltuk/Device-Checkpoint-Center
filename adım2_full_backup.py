...
desktop_path = '/opt/dcs/data/FULL_BACKUP/'
old_access_file_path = os.path.join(desktop_path, 'old_full_backup.txt')
new_access_file_path = os.path.join(desktop_path, 'new_full_backup.txt')
different_file_path = os.path.join(desktop_path, 'full_backup-different.txt')
